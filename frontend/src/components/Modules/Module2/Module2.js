        ...
        <div className="content-grid">
          ...
          <div className="section debt-outcome">
            ...
            <label style={{ opacity: checkedItems.spendingHabits ? 0.5 : 1 }}>
                  ...
                  />
                  <span style={{ marginLeft: '5px', fontWeight: 'bold' }}>Gather financial statements to collect statements for all debts, income sources, and expenses.</span>
                </label>
            <div>
            <label style={{ opacity: checkedItems.createBudget ? 0.5 : 1 }}>
                  ...
                  />
                  <span style={{ marginLeft: '5px', fontWeight: 'bold' }}>Look into consolidating high-interest debts into a lower-interest loan or credit card. Focus on paying off debts with the highest interest rates first to minimize overall interest costs.</span>
                </label>
            </div>
            <div>
                <label style={{ opacity: checkedItems.setPriorities ? 0.5 : 1 }}>
                  ...
                  />
                  <span style={{ marginLeft: '5px', fontWeight: 'bold' }}>Utilize the debt repayment calculator below to evaluate your financial health.</span>
                </label>
              </div>
            </div>
          </div>
